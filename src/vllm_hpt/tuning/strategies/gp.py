"""Gaussian Process search strategy."""
...
class GPStrategy(SearchStrategy):
    """Search strategy using Optuna's Gaussian Process sampler."""
    ...
    def _create_sampler(self) -> optuna.samplers.BaseSampler:
        try:
            ...
            raise ImportError(
                "GP strategy requires PyTorch. Install with: uv sync --extra gp"
            )
